...
python src/evaluation/plot_train_results.py -u $OUTPUT_PATH/unpolarized/model/train_results.json -g $OUTPUT_PATH/global/model/train_results.json -d $OUTPUT_PATH/direct/model/train_results.json -o $OUTPUT_PATH/results/graphs
